document.addEventListener("DOMContentLoaded", () => {
  ...
  formulario.addEventListener("submit", (e) => {
    ...
    const imgURL = imagen ? URL.createObjectURL(imagen) : "";
    ...
    if (descuento) {
      ...
      precioFinal = (precio - (precio * descuentoNum / 100)).toFixed(2);
      precioHTML = `
      <p><strong>Precio:</strong> <del>$${precio}</del> → $${precioFinal} (-${descuentoNum}%)</p>
      `;
    }
...
`;
    ...
    editarBtn.addEventListener("click", () => {
      ...
      formEdicion.addEventListener("submit", (e) => {
        ...
        // Actualización visual condicional
        ...
        // Actualizar el bloque de precio
        ...
        if (nuevaImagen) {
          const nuevaURL = URL.createObjectURL(nuevaImagen);
